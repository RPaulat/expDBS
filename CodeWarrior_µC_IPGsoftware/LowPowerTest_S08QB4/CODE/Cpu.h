...
#define CPU_BUS_CLK_HZ              0x4000UL /* Initial value of the bus clock frequency in Hz */

#define CPU_INSTR_CLK_HZ            0x4000UL /* Initial value of the instruction clock frequency in Hz */
...
#define CPU_DERIVATIVE_MC9S08QB4       /* Name of the selected cpu derivative */
#define CPU_PARTNUM_MC9S08QB4CTG       /* Part number of the selected cpu */
